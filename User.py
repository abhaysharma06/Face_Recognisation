                                                    #Python code for Attendance Using Facial Reco.
...
message = tk.Label(window, text="Facial Scan" ,bg="White"  ,fg="dark slate gray"  ,width=9  ,height=1,font=('times', 30, 'italic bold underline')) 

message.place(x=580, y=40)

lbl = tk.Label(window, text="Pass Number",width=15  ,height=1  ,fg="dark olive green"  ,bg="white" ,font=('times', 15, ' bold ') ) 
lbl.place(x=380, y=200)

txt = tk.Entry(window,width=20  ,bg="white" ,fg="dark olive green", font=('times', 15, ' bold '))
txt.place(x=800, y=202)

lbl2 = tk.Label(window, text="Name",width=15  ,fg="dark olive green"  ,bg="white"    ,height=1 ,font=('times', 15, ' bold ')) 
lbl2.place(x=380, y=300)

txt2 = tk.Entry(window,width=20  ,bg="white"  ,fg="dark olive green",font=('times', 15, ' bold ')  )
txt2.place(x=800, y=302)

lbl3 = tk.Label(window, text="Notification : ",width=15  ,fg="dark olive green"  ,bg="white"  ,height=1 ,font=('times', 15, ' bold underline ')) 
lbl3.place(x=70, y=705)

message = tk.Label(window, text="" ,bg="white"  ,fg="dark olive green"  ,width=18  ,height=1, activebackground = "white" ,font=('times', 15, ' bold ')) 
message.place(x=578, y=705)
...
takeImg = tk.Button(window, text="Capture", command=TakeImages  ,fg="dark olive green"  ,bg="white"  ,width=18  ,height=1, activebackground = "dark olive green" ,font=('times', 15, ' bold '))
takeImg.place(x=578, y=400)
trainImg = tk.Button(window, text="Next", command=TrainImages  ,fg="dark olive green"  ,bg="white"  ,width=18  ,height=1, activebackground = "dark olive green" ,font=('times', 15, ' bold '))
trainImg.place(x=578, y=500)
#trackImg = tk.Button(window, text="Mark Attadence", command=TrackImages  ,fg="dark olive green"  ,bg="white"  ,width=15  ,height=1, activebackground = "dark olive green" ,font=('times', 15, ' bold '))
